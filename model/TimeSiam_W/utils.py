"""Paths, device selection, and tiny formatting helpers used by TimeSiam."""
...
def seed_everything(seed: int) -> None:
    """Seed Python, NumPy, and PyTorch RNGs for one experiment replicate."""
    random.seed(seed)
    np.random.seed(seed)
...
def format_param(value: float | int) -> str:
    """Compact float/int -> string used in setting-name builders."""
